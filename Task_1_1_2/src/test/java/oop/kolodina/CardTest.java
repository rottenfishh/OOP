...
public class CardTest {
  ...
  public void testToString() {
    String string1 =
        testCard1.rank.getRuName() + " " + testCard1.mark.getRuName() + " (" + testCard1.getValue()
            + ")";
    String string2 =
        testCard2.rank.getRuName() + " " + testCard2.mark.getRuName() + " (" + testCard2.getValue()
            + ")";
    String string3 =
        testCard3.rank.getRuName() + " " + testCard3.mark.getRuName() + " (" + testCard3.getValue()
            + ")";
    String string4 =
        testCard4.rank.getRuName() + " " + testCard4.mark.getRuName() + " (" + testCard4.getValue()
            + ")";
