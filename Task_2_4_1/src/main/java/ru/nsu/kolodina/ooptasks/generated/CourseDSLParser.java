...
public class CourseDSLParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, T__26=27, STRING=28, INT=29, WS=30, COMMENTARY=31;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'score'", "'buildTool'", "'criteries'", "'grading'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, "STRING", "INT", "WS", "COMMENTARY"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 237306886L) != 0)) {
				{
				setState(42);
				_errHandler.sync(this);
